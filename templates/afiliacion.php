 ...
 * Description: Plantilla para la sección "Afiliación" del sitio.
 */
get_template_part('templates/header');
?>
<div class="certificacion-wrapper">
	<div class="col-md-12 col-xs-12">
		<div class="breadcrumb hidden-xs"><a href="<?php echo get_bloginfo('url'); ?>">Inicio</a> > Afiliación</div>
		<div class="col-md-3 col-xs-12">
			<h2 class="page-banner">Afiliación</h2>
		</div>
