...
<div class="certificacion-wrapper">
	<div class="col-md-12 col-xs-12">
		<div class="breadcrumb hidden-xs"><a href="<?php echo get_bloginfo('url'); ?>">Inicio</a> > Blog Inmobiliario</div>
		<div class="col-md-3 col-xs-12">
			<h2 class="page-banner">Blog Inmobiliario</h2>
		</div>
		<div class="col-md-9 col-xs-12">
			<div class="inner-content">
				<div class="articulo">
					...
					<?php $fecha = ucwords( get_the_date() ); ?>
					<span class="fecha">Publicado el <span class="dia"><?php the_date('l'); ?></span> <?php echo $fecha; ?></span>
					<?php
								the_content();
							endwhile; 
						endif;
				 ...
				 <p class="text-right button-action">
                    <a href="<?php echo get_page_link( get_page_by_title('blog inmobiliario')->ID ); ?>" class="button">Ir al blog</a>
                </p>
			</div>
		</div>
	</div>
