 ...
 */
// Text Domain
load_theme_textdomain( 'ciebo', get_template_directory() . '/assets/lang' );
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() {
        wp_register_style( 'bootstrap', get_template_directory_uri() . '/assets/bootstrap-3.3.2/css/bootstrap.min.css', array(), '3.3.2', 'all' );
        ...
        wp_register_style( 'fontawesome', get_template_directory_uri() . '/assets/font-awesome-4.3.0/css/font-awesome.min.css', array(), '4.3.0', 'all' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js() {
    wp_register_script( 'bootstrap', 
      get_template_directory_uri() . '/assets/bootstrap-3.3.2/js/bootstrap.min.js', 
      array('jquery'), 
      '3.3.2' );
    ...
    wp_register_script( 'google-fonts',
      get_template_directory_uri() . '/assets/scripts/google-fonts.js',
      '',
      '1.5.10'
    );
...
function ciebo_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      'jumbotron_hpquote',
      array(
        'label'          => __( 'Frase de Entrada', 'ciebo' ),
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      array(
        'label'          => __( 'Título del Botón', 'ciebo' ),
        'section'        => 'ciebo_front_end',
  ...
  $wp_customize->add_control(
    new WP_Customize_Control(
      ...
      array(
        'label'          => __( 'Enlace del Botón', 'ciebo' ),
        'section'        => 'ciebo_front_end',
...
add_action( 'customize_register', 'ciebo_customize_register' );
/**
 * Picturefill Async
 */
...
function the_breadcrumb() {
    ...
    echo '<ol class="breadcrumb">';
      ...
      elseif (  is_day()  ) { echo "<li>".__('Archivo','ciebo')." "; the_time('F jS, Y'); echo '</li>'; }
      elseif (  is_month()  ) { echo "<li>".__('Archivo','ciebo')." "; the_time('F, Y'); echo '</li>'; }
      elseif (  is_year() ) {  echo "<li>".__('Archivo','ciebo')." "; the_time('Y'); echo '</li>'; }
      elseif (  is_author() ) {  echo"<li>".__('Autor','ciebo')." "; echo '</li>'; }
      elseif (  isset($_GET['paged']) && !empty($_GET['paged']) ) {  echo "<li>".__('Archivos','ciebo'); echo '</li>'; }
      elseif (  is_search() ) { echo "<li>".__('Resultados','ciebo'); echo '</li>'; }
    echo '</ol>';
}
/**
 * Disqus Comments
